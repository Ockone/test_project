    ...
    <!--一条开始-->
    	<div class="public_m1">
            ...
            <div class="zp_nrm">
                ...
                <!--right-->
                <div class="zp_nrm_r">
                	<p>用户名:<c:out value="${currUser.userName}"></c:out></p>
                    <p><i>邀请码:bookstore132456487943321</i><font>(推荐邀请有奖)</font></p>
                    <p>邮箱:<c:out value="${currUser.userEmail}"></c:out><a href="#">更改绑定</a></p>
                    <p>手机号:<c:out value="${currUser.userTele}"></c:out><a href="#">更改绑定</a></p>
                    <p>地址:<c:out value="${currUser.userAddress}"></c:out><a href="#">立即修改</a></p>
                    <p>
                      <c:choose>
                        <c:when test="${currUser.userSex=='男'}">
                        	<input type="radio" name="sex" class="sex_m"><i>保密</i>
		                    <input type="radio" name="sex" class="sex_m" checked="checked"><i>男</i>
		                    <input type="radio" name="sex" class="sex_m" ><i>女</i></p>
                        </c:when>
                        <c:when test="${currUser.userSex=='女'}">
                        	<input type="radio" name="sex" class="sex_m"><i>保密</i>
		                    <input type="radio" name="sex" class="sex_m"><i>男</i>
		                    <input type="radio" name="sex" class="sex_m" checked="checked"><i>女</i></p>
                        </c:when>
                        <c:otherwise>
                        	<input type="radio" name="sex" class="sex_m" checked="checked"><i>保密</i>
		                    <input type="radio" name="sex" class="sex_m"><i>男</i>
		                    <input type="radio" name="sex" class="sex_m" ><i>女</i></p>
                        </c:otherwise>
                      </c:choose> 
                    <span class="borth_m">
                    	 <c:out value="生日:${currUser.userBirth}"></c:out>
                    	 <br>
